    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="mb-8 border border-gray-100">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          ...
          {storedBillingKey
            ? <button onClick={() => setShowCardForm(v => !v)} className="text-[10px] font-bold text-gray-400 hover:text-black">재등록</button>
            : <button onClick={() => setShowCardForm(v => !v)} className="bg-black px-3 py-1.5 text-[10px] font-black text-white hover:bg-red-500 transition-colors">카드 등록</button>
          }
        </div>
        ...
        {storedBillingKey && !showCardForm && (
          <div className="flex items-center gap-3 px-5 py-3">
            ...
            <div>
              <p className="text-xs font-bold text-gray-800">카드 등록 완료</p>
        ...
        {showCardForm && (
          <div className="px-5 py-4 space-y-3">
            ...
            <div className="flex gap-2 pt-1">
              <button onClick={() => setShowCardForm(false)} className="flex-1 border border-gray-200 py-2 text-xs font-bold text-gray-400 hover:text-black transition-colors">취소</button>
              <button
            ...
            {coupons.map((coupon: any) => {
              ...
              return (
                <div key={coupon.userCouponId ?? coupon.couponId} className="flex items-center justify-between px-5 py-4">
                  ...
                  <span className={`shrink-0 text-[10px] font-black tracking-wider px-2 py-1 ${
                    isValid ? 'text-red-500 bg-red-50' : 'text-gray-300 bg-gray-50'
                  }`}>
      ...
      <div className="mb-8 border border-gray-100">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs font-black tracking-widest text-gray-900">배송지 관리</p>
          </div>
        ...
        {showAddressForm && (
          <div className="px-5 py-4 border-b border-gray-100 bg-gray-50 space-y-2">
            {[
              ...
              { label: '상세 주소', key: 'addressDetail', placeholder: '101호' },
              ...
              <div key={addr.addressId} className="flex items-start justify-between px-5 py-4">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    {addr.isDefault && <span className="px-1.5 py-0.5 text-[9px] font-black bg-black text-white tracking-wider">기본</span>}
                  </div>
                ...
                <div className="flex gap-2 shrink-0 ml-3">
                  {!addr.isDefault && (
                    <button onClick={() => setDefaultAddressMutation.mutate(addr.addressId)} className="text-gray-300 hover:text-yellow-500 transition-colors" title="기본 배송지 설정">
                      <Star size={13} />
                    </button>
                  )}
                  <button
      ...
      <div className="mb-8 border border-gray-100">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs font-black tracking-widest text-gray-900">프로필 수정</p>
          </div>
          <button onClick={() => { setShowProfileEdit(v => !v); setProfileForm({ nickname: profile?.nickname ?? '', slackId: profile?.slackId ?? '' }) }}
          ...
          <div className="w-full max-w-sm border border-gray-100 bg-white p-6 shadow-xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-black py-2.5 text-xs font-black text-white hover:bg-red-500 disabled:opacity-50 transition-colors"
              >
