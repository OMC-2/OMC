...
import com.omc.order.application.processor.RdbmsDlqProcessor;
...
public class KafkaConsumerConfig {
  ...
  @Bean
  public DefaultErrorHandler kafkaErrorHandler(RdbmsDlqProcessor rdbmsDlqProcessor) {
    ...
    DefaultErrorHandler handler = new DefaultErrorHandler(rdbmsDlqProcessor, backOff);
