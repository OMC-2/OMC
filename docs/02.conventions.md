...
모든 서비스는 4계층 구조를 따릅니다. 패키지 루트는 `com.sparta.omc.{service-name}` 입니다.

```
com.sparta.omc.{service-name}
├── presentation/
│   ├── controller/
│   └── dto/
│       ├── request/
...
| 서비스 | 패키지 루트 |
|---|---|
| `user-service` | `com.sparta.omc.user` |
| `drop-service` | `com.sparta.omc.drop` |
| `order-service` | `com.sparta.omc.order` |
| `product-service` | `com.sparta.omc.product` |
| `payment-service` | `com.sparta.omc.payment` |
| `raffle-service` | `com.sparta.omc.raffle` |
| `coupon-service` | `com.sparta.omc.coupon` |
| `notification-service` | `com.sparta.omc.notification` |
