Feature: 관리자 응모자 목록 조회 및 수동 추첨
  ...
  # ================================================================
  # 래플 응모자 목록 조회 + OPEN 상태에서의 수동 추첨 실행 검증
  # 실행: bash e2e/run.sh scenario/05_admin/04_raffle_draw
  #
  # 시나리오 목록:
  #   1. 응모자 목록 조회 → 200, content 배열/totalElements 반환
  #   2. 상태 OPEN 강제 변경 → 수동 추첨 실행 → 200
  #
